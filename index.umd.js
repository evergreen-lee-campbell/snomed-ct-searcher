(function (global, factory) {
	...
	(global = global || self, factory(global.snomedSearch = {}, global.fetch));
	...
	function getChildCodes(code, options) {
	    return __awaiter(this, void 0, void 0, function* () {
	        let topLevelConcept;
	        try {
	...
	function _download() {
	    ...
	    downloadA.attr('download', (jquery('#search').val() || childCodes[0].defaultTerm || Date.now()) + ".csv");
	    downloadA.show();
	}

	exports._download = _download;
	exports._getChildCodes = _getChildCodes;
